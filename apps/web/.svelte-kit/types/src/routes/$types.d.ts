...
type LayoutRouteId = RouteId | "/" | "/(app)/leaderboard" | "/(app)/profile" | "/(app)/profile/billing" | "/(app)/profile/settings" | "/(app)/profile/settings/verify-email" | "/(app)/session" | "/(app)/session/[id]" | "/(auth)/login" | "/(auth)/verify" | "/onboarding" | "/plan" | null
